...
(function (root, factory) {
    ...
    Calendar.prototype = {
        ...
        trigger: function () {
            ...
            this.$trigger = this.options.trigger instanceof $ ? this.options.trigger 
        ...
        event: function () {
            ...
            _this.$element.on('click', DISPLAY_VD, function() {
                ...
                _this.updateDateView(this.innerHTML);
            });
